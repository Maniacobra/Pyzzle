...
public class PyzzFileLoader {

    private static final PyzzFileLoader instance = new PyzzFileLoader();

    public static PyzzFileLoader getInstance() {
        return instance;
    }

    // CLASS

    private PyzzFileLoader() {
    }
